...
trinucleotides_counts = analysis_data[["Pan-Cancer"]]
load("final_results/signatures_assignment.RData")

# perform signatures significance estimation
set.seed(12345)
signatures_significance = signaturesSignificance(x=trinucleotides_counts,beta=signatures_assignment$beta,cosine_thr=0.95,min_contribution=0.05,pvalue_thr=0.05,nboot=100,num_processes=100,verbose=TRUE)
