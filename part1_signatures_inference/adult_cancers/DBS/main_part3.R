...
# make plots data
IDs = sort(unique(rownames(dbs_counts)))
...
unexplained_mut_norm = as.numeric(unexplained_mut/rowSums(dbs_counts)[IDs])
...
UNEXPLAINED_MUTATIONS = c(UNEXPLAINED_MUTATIONS,unexplained_mut)
UNEXPLAINED_MUTATIONS_NORM = c(UNEXPLAINED_MUTATIONS_NORM,unexplained_mut_norm)
CATALOGUE = c(CATALOGUE,rep("Reference Signatures",length(IDs)))
PREDICTIONS = c(PREDICTIONS,as.numeric(reference_signatures_goodness_fit[IDs]))
unexplained_mut = as.numeric(reference_signatures_assignment$unexplained_mutations[IDs])
unexplained_mut_norm = as.numeric(unexplained_mut/rowSums(dbs_counts)[IDs])
UNEXPLAINED_MUTATIONS = c(UNEXPLAINED_MUTATIONS,unexplained_mut)
UNEXPLAINED_MUTATIONS_NORM = c(UNEXPLAINED_MUTATIONS_NORM,unexplained_mut_norm)
