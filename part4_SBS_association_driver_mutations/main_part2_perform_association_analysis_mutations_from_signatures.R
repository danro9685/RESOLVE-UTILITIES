...
library("lsa")
library("parallel")
source("R/association.estimation_mutations_from_signatures.R")
...
# save the results
save(analysis_data_driver,file="results/mutations_from_signatures/analysis_data_driver.RData")
save(analysis_results_driver,file="results/mutations_from_signatures/analysis_results_driver.RData")
